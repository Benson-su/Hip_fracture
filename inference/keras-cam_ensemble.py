...
def return_heatmap(image_for_model, cam_model):
    ...
    for output_dir_class in output_dir_classes: 
        for test_class in test_classes:
            ...
            #    print("filename: "+str(onefilename))
                ...
                '''
                sum_map += return_heatmap(image_for_model, cam_model)
                print(sum_map)
                print("\n\n")
                # write image with probability to csv

                csv_output = "./prob_folder_new/fx_prob_" + test_class + "_"+ output_dir_class + ".csv"
